...
const TermsOfUseComponent: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="mb-4">
        Welcome to QRganiz! These terms and conditions outline the rules and
      ...
      <p className="mb-4">
        You agree to use QRganiz responsibly and in compliance with all
      ...
      <p className="mb-4">
        ...
        QR codes. QRganiz is not responsible for any data loss or unauthorized
        access.
      </p>
      ...
      <p className="mb-4">
        All content, trademarks, and logos on QRganiz are the property of their
      ...
      <p className="mb-4">
        QRganiz may update these Terms of Use from time to time. Continued use
      ...
      <p className="mb-4">
        ...
        <a href="mailto:support@qrganiz.com" className="text-blue-500">
          support@qrganiz.com
        </a>
        .
      </p>
